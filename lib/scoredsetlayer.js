(function () {
     ...
     * @param [options] {Object} limit: limits the number of ids returned.  reverse: boolean, reverses the order the scores are returned.
     * @param callback {Function}
     */
    ssl.getscores = function densitySetGetScores(low, high, options, callback) {
        ...
        thiz.transaction.getRange(
            ...
            fdb.tuple.pack(thiz.identifier.concat(["___sys_score", high+1])),  {limit: options.limit, reverse: options.reverse }).toArray(function(err, kvArr)
        {
